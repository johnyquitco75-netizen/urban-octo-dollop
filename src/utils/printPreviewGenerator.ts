  ...
  const headerHtml = `
    <div class="header-container" style="display: flex; justify-content: center; margin-bottom: 20px;">
        <div class="header-content" style="display: flex; justify-content: center; align-items: center; max-width: 800px; width: 100%;">
            ...
            ${rightHeaderLogoData ? `<img src="${rightHeaderLogoData}" class="header-logo" alt="Right Logo" style="width: 60px; height: 60px; object-fit: contain; margin-left: ${rightHeaderLogoMargin}px; flex-shrink: 0;">` : `<div style="width: 60px; margin-left: ${rightHeaderLogoMargin}px; flex-shrink: 0;"></div>`}
        </div>
    </div>
